    ...
    <nav class="px-[40px] py-[40px]  w-screen">
      <div class="container flex flex-wrap justify-between items-center mx-auto">
        <a href="javascript:void(0)" class="flex items-center">
          <img src="../src/assets/Union.png" class="mr-3 h-9 sm:h-9" alt="MynthMedia Logo" />
        </a>
        <div class="flex items-center md:order-2">
          <span data-dropdown-toggle="language-dropdown-menu " class="mr-[20px] inline-flex justify-center items-center p-2 text-sm text-white rounded cursor-pointer ">
            <img class="w-8 h-8 rounded-full mr-[10px]" src="../src/assets/profile.png" alt="" />
            1AZFAFASFASZ
          </span>
          <img class="w-8 h-8 rounded-full mr-[5px] w-[20px] h-[20px] hidden justify-between items-center w-full md:flex md:w-auto md:order-1" src="../src/assets/notif.png" alt="" />
          <img class="w-8 h-8 rounded-full mr-[5px] w-[20px] h-[20px] hidden justify-between items-center w-full md:flex md:w-auto md:order-1" src="../src/assets/settings.png" alt="" />
